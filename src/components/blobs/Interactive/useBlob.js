...
export default function useBlob (element_selector, parent_selector) {
  useLayoutEffect(() => {
    const blob = new Blob;

    const canvas = document.querySelector(element_selector),
          canvasContainer = document.querySelector(parent_selector);

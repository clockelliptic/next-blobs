...
const defaultProps = {
    buttonColor: "#3B8EF3",
    buttonColorOpen: "#D8FBF2"
}

type IMenuProps = {
    buttonColor?: string,
    buttonColorOpen?: string
}

export default function Menu (props: IMenuProps = defaultProps) {
    ...
    return (<>
        <button title="Navigation Menu" id="menuButton" onClick={toggleMenu} className={`amh-menuButton${open?' open':''}`}>
        ...
        <style jsx global>{`
            ...
            .amh-menuButton:hover {
                cursor: pointer;
            }
            .amh-menuButton.open {    
                stroke: ${props.buttonColorOpen};
                fill: ${props.buttonColorOpen};
            ...
            .amh-navMenu {
                ...
                clip-path: circle(2rem at calc(100% - 3.5rem) 3.5rem);
                -webkit-clip-path: circle(2rem at calc(100% - 3.5rem) 3.5rem);
            }
            .amh-navMenu.open {
                display: flex;
                opacity: 1;
